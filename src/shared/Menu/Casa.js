    ...
    return(
        <>
           <img src="https://firebasestorage.googleapis.com/v0/b/jjgtiendatcc.appspot.com/o/banner.jpg?alt=media&token=277b2663-b94b-4bd8-b6de-0b3c113541c9" alt="banner" className="w-100 img-fluid"/>
            ...
            <div className="container-fluid bg-dark g-0 p-5 mt-5">
                <div className="row justify-content-center">
                    <div className="col-12 col-md-4 border-end">
                        <img src="https://firebasestorage.googleapis.com/v0/b/jjgtiendatcc.appspot.com/o/Incubus_Fish_Tattoo-logo-12FFF0ADC6-seeklogo.com.png?alt=media&token=4556e05f-4468-4834-845b-477e5c23b3bd" className="img-fluid w-100"/>
                    </div>
                    <div className="col-12 col-md-4 text-white text-start align-self-center">
                        <h2>INCUBUS BAND &copy;</h2>
                        <i className="bi bi-facebook fs-1 me-2"></i>
                        <i className="bi bi-tiktok fs-1 me-2"></i>
