export function Casa(){
    ...
    return(
        <>
           <img src="https://firebasestorage.googleapis.com/v0/b/jjgtiendatcc.appspot.com/o/banner.jpg?alt=media&token=277b2663-b94b-4bd8-b6de-0b3c113541c9" alt="banner" classNameName="w-100 img-fluid"/>
            ...
            <section>
                <div classNameName="container">
                    ...
                    <div classNameName="row">
                        <div classNameName="col-12 col-md-8">
                            <img src="https://firebasestorage.googleapis.com/v0/b/jjgtiendatcc.appspot.com/o/21753018_10155226596903999_29998736812000224_o.jpg?alt=media&token=335e9325-5a9f-4fe9-ba57-0a2333222108" classNameName="img-fluid w-100" alt="live" />
                        </div>
            ...
            <div classNameName="container-fluid bg-dark g-0 p-5 mt-5">
                <div classNameName="row justify-content-center">
                    <div classNameName="col-12 col-md-4 border-end">
                        <img src="https://firebasestorage.googleapis.com/v0/b/jjgtiendatcc.appspot.com/o/Incubus_Fish_Tattoo-logo-12FFF0ADC6-seeklogo.com.png?alt=media&token=4556e05f-4468-4834-845b-477e5c23b3bd" classNameName="img-fluid w-100"/>
                    </div>
                    <div classNameName="col-12 col-md-4 text-white text-start align-self-center">
                        <h2>INCUBUS BAND &copy;</h2>
                        <i classNameName="bi bi-facebook fs-1 me-2"></i>
                        <i classNameName="bi bi-tiktok fs-1 me-2"></i>
                        <i classNameName="bi bi-instagram fs-1 me-2"></i>
                        <h4 classNameName="mt-5">Todos los derechos reservados</h4>
